...
def evaluate_dcp_on_dataset(hazy_dir, gt_dir, output_dir):
    ...
    for hazy_name in hazy_list:
        ...
        # 获取前缀（如 01_outdoor），替换 _hazy → _GT，得到对应 GT 图名
        prefix = hazy_name.lower().replace("_hazy", "_gt").replace(".jpg", "").replace(".jpeg", "")
...
if __name__ == '__main__':
    hazy_dir = r"D:\New_Desktop\# O-HAZY NTIRE 2018\hazy"
    gt_dir = r"D:\New_Desktop\# O-HAZY NTIRE 2018\GT"
    output_dir = r"D:\New_Desktop\# O-HAZY NTIRE 2018\results_dcp"
